        ...
        <x-backend.card>
            ...
            <x-slot name="body">
                <div x-data="{userType : '{{ $model::TYPE_USER }}'}">
                    ...
                    <div class="form-group row" x-show="userType === '{{ $model::TYPE_USER }}'">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="alias" class="form-control" placeholder="{{ __('Alias') }}" value="{{ old('alias') }}" maxlength="15" required />
                        </div>
                    </div><!--form-group-->
