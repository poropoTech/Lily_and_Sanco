<div id="image-selector-{{$id}}" class="image-selector">
    ...
    <button type="button" id="image-selector-browse-{{$id}}" class="{{$classBrowseBtn}} image-selector-browse">@lang('components_forms.img-selector.select_image')</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary image-selector-cancel-btn">@lang('components_forms.img-selector.cancel_button')</button>
                    <button type="button" class="btn btn-primary image-selector-crop-btn">@lang('components_forms.img-selector.select_button')</button>
                </div>
            </div>
        </div>
    </div>
