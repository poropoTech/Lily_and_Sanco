...
@section('title', __('frontend_pages_category.page_title'))
            ...
            <div class="col-md-6">
                ...
                <div class="activity-title-container justify-content-md-center">
                    <div class="activity-title-text">
                        <span class="activity-title-title">{{ strtoupper($category->name) }}<br><span class="activity-title-name">@lang('frontend_pages_category.title')</span> </span>
                    </div>
                </div>
            </div><!--col-md-6-->
            <div class="col-md-6">
