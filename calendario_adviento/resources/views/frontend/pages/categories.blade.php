...
@section('title', __('frontend_pages_categories.page_title'))

@section('content')
    @include('frontend.includes.partials.breadcrumbs')
    <div class="page-header-img-container">
        <div>
            <img class="img-fluid" src="{{asset('img/default/activity/header.jpg')}}">
        </div>
    </div>
...
{{--        </div>--}}
        <div class="full-width" style="background-color: #f8f8f8">
            <div class="container py-4">
                <div class="row">
                    <div class="col-md-4 text-left">
                        <h2>@lang('frontend_pages_categories.title')</h2>
                    </div>
                </div>
