...
$upload_dir = 'storage/files/uploads/';
$thumbs_upload_dir = 'storage/files/thumbs/';
$current_path = 'storage/files/uploads/';
$thumbs_base_path = 'storage/files/thumbs/';
