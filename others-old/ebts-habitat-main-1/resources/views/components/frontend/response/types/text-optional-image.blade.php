...
<input type="hidden" name="type_id" value="{{$model::TYPE_T_OI}}">
        ...
        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#response-new-modal-accordion">
            <div class="card-body">
                <div class="form-group row">
                    <div class="col-md-12">
                        <textarea class="form-control emoji-text-input"  name="content" rows="3" placeholder="Mensaje"></textarea>
                    </div>
                </div><!--form-group-->
            </div>
        </div>
