...
class FileManagerServiceProvider extends ServiceProvider
{
    ...
    {
        $FMPATH = base_path('vendor/kwaadpepper/laravel-responsivefilemanager/src/ResponsiveFileManager');
        // Add package routes.
        $this->loadRoutesFrom(__DIR__ . '/routes.php');
        $this->loadJsonTranslationsFrom($FMPATH.'/../I18N');
        ...
        $FM_PUBLISH[$FMPATH . $FMPRIVPATH . 'config/config.php'] = config_path('rfm.php');//phpcs:ignore
        ...
        $FM_PUBLISH[$FMPATH . $FMPRIVPATH . 'config/config.php'] = config_path('rfm.php');//phpcs:ignore
        $FM_PUBLISH[$FMPATH . $FMPRIVPATH . '/plugin.min.js'] = public_path($FMPUBPATH . '/plugin.min.js');//phpcs:ignore
        $FM_PUBLISH[$FMPATH . $FMPRIVPATH . '/css'] = public_path($FMPUBPATH . '/css');//phpcs:ignore
        $FM_PUBLISH[$FMPATH . $FMPRIVPATH . '/img'] = public_path($FMPUBPATH . '/img');//phpcs:ignore
        $FM_PUBLISH[$FMPATH . $FMPRIVPATH . '/js'] = public_path($FMPUBPATH . '/js');//phpcs:ignore
        $FM_PUBLISH[$FMPATH . $FMPRIVPATH . '/svg'] = public_path($FMPUBPATH . '/svg');//phpcs:ignore
        $FM_PUBLISH[$FMPATH.'/../I18N'] = resource_path('lang/vendor/rfm');
