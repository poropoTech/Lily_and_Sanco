<li class="c-sidebar-nav-dropdown {{ activeClass(Route::is('admin.config.app.*'), 'c-open c-show') }}">
    ...
    <ul class="c-sidebar-nav-dropdown-items">
        @if (
                    ...
                    (
                        $logged_in_user->can('admin.access.app-config.running')
                    )
                )
            <li class="c-sidebar-nav-item">
                <x-utils.link
                    :href="route('admin.config.app.running.index')"
                    class="c-sidebar-nav-link"
                    :text="__('Gestión de Funcionamiento')"
                    :active="activeClass(Route::is('admin.config.app.running'), 'c-active')" />
            </li>
        @endif
        @if (
                $logged_in_user->hasAllAccess() ||
            ...
            <li class="c-sidebar-nav-item">
                <x-utils.link
                    ...
                    :active="activeClass(Route::is('admin.config.app.notifications'), 'c-active')" />
            </li>
        @endif
    </ul>
</li>
