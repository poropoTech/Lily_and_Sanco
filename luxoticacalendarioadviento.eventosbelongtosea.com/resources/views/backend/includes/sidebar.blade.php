<div class="c-sidebar c-sidebar-light c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    <div class="c-sidebar-brand d-lg-down-none">
        <img src="{{ asset('img/logos/logo.png#full') }}" class="c-sidebar-brand-full" width="118" height="46" alt="Logo">
        <img src="{{ asset('img/logos/logo.png#full') }}" class="c-sidebar-brand-minimized" width="46" height="46" alt="Logo">
    </div><!--c-sidebar-brand-->
    ...
    <ul class="c-sidebar-nav">
        ...
        @if (
               $logged_in_user->hasAllAccess() ||
               (
                   $logged_in_user->can('admin.access.statistics')
               )
           )
