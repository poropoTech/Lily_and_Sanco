                    ...
                    @php
                        if($activity->isActive()) {
                            ...
                            if(! $activity->isDone($logged_in_user)){
                                $btnText = __('components_frontend.activity.card.challenge_active');
                            }else{
                                $btnText = __('components_frontend.activity.card.challenge_done');
                            }
                        } else {
                            $btnClass = 'disabled activity-card-response-btn-disabled';
                            $btnText = __('components_frontend.activity.card.challenge_inactive');
                        }
                    @endphp
