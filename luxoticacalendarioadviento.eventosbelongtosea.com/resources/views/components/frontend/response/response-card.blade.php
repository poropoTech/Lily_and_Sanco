    ...
    <div class="">
        ...
        <div class="response-card-text">
            ...
            <div class="response-card-text-like font-weight-bold">
                @lang('components_frontend.response.card.likes_to')<span class="response-card-like-counter">{{ $response->likes()->count() }}</span>@lang('components_frontend.response.card.people')
            </div>
            <div class="response-card-text-comments font-weight-bold">
                <a ref="#" role="button" class="response-card-comment-btn ">@lang('components_frontend.response.card.see_the')<span class="response-card-comment-counter">{{ $response->comments()->onlyPublished()->count() }}</span>@lang('components_frontend.response.card.comments')</a>
            </div>
