<div id="image-double-selector-{{$id}}" class="image-double-selector">
    <div class="row">
        <div class="col-md-2">
            ...
            <button type="button" id="image-double-selector-browse-{{$id}}" class="{{$classBrowseBtn}} image-double-selector-browse">@lang('components_forms.img-double-selector.select_image')</button>
{{--            <button type="button" id="image-double-selector-delete-{{$id}}" class="{{$classDeleteBtn}} image-double-selector-delete">Eliminar</button>--}}
        ...
        <div class="col-md-10">
            <div class="row">
                <div class="col">
                    <p>@lang('components_forms.img-double-selector.header_image')</p>
                ...
                <div class="col">
                    <p>@lang('components_forms.img-double-selector.card_image')</p>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        <div class="col">
                            <h2>@lang('components_forms.img-double-selector.header_image')</h2>
                    ...
                    <div class="row">
                        <div class="col">
                            <h2>@lang('components_forms.img-double-selector.card_image')</h2>
                            <div class="img-container img-thumbnail">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary image-double-selector-cancel-btn">@lang('components_forms.img-double-selector.cancel_button')</button>
                    <button type="button" class="btn btn-primary image-double-selector-crop-btn">@lang('components_forms.img-double-selector.select_button')</button>
                </div>
            </div>
        </div>
    </div>
