...
@section('title', __('frontend_pages_activity.page_title'))
        ...
        <div class="row py-5 justify-content-center">
            <div class="col-md-6 activity-title">
                <div class="text-md-left">
                    <h2 class="activity-category-name-txt">{{ $activity->category->name }}</h2>
            ...
            <div class="container py-4">
                <div class="row justify-content-center">
                    <div class="col-md-10 text-center">
                        <div class="row pt-3">
                            <div class="col">
                                <i class="fas fa-3x fa-user" style="color: #ae8000ff"></i>
                                <h2>@lang('frontend_pages_activity.individual_challenge_title')</h2>
                            </div>
                        </div>
                        <div class="row py-4">
...
--}}
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 text-center">
                <div class="row pt-5">
                    <div class="col">
                        <i class="fas fa-3x fa-users" style="color: #ae8000ff"></i>
                        <h2>@lang('frontend_pages_activity.collective_challenge_title')</h2>
                    </div>
                </div>
                <div class="row py-4">
                    <div class="col activity-content">
        ...
        <div class="activity-user-challenges-section">
            <div class="row justify-content-center py-3">
                <h2>@lang('frontend_pages_activity.more_challenges')</h2>
                <div class="col-md-12">
