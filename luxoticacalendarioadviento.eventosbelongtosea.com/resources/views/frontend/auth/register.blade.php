...
@section('title', __('frontend_auth.register.page_title'))
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 text-md-right">
                    <div class="register-img-text">
                        <p class="register-title text-left">
                            @lang('frontend_auth.register.text')
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input type="text" name="name" id="name" class="form-control form-control-sm" value="{{ old('name') }}"
                                       placeholder="{{ __('general.user_name') }}" maxlength="100" required autofocus
                                       autocomplete="name"/>
                            </div>
                        </div><!--form-group-->
...
{{--                        </div><!--form-group-->--}}
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <select name="department_id" id="department_id"class="form-control form-control-sm" required>
                                    <option disabled selected>@lang('frontend_auth.register.select_department')</option>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input type="email" name="email" id="email" class="form-control form-control-sm"
                                       placeholder="{{ __('general.email') }}" value="{{ old('email') }}" maxlength="255"
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input type="password" name="password" id="password" class="form-control form-control-sm"
                                       placeholder="{{ __('general.password') }}" maxlength="100" required
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input type="password" name="password_confirmation" id="password_confirmation"
                                       class="form-control form-control-sm" placeholder="{{ __('general.confirm_password') }}" maxlength="100"
                            ...
                            <div class="col-md-12 mt-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label small" for="terms">
                                        @lang('frontend_auth.register.accept_the') <a href="{{ route('frontend.pages.terms') }}"
                                                                   target="_blank">@lang('frontend_auth.register.policy')</a>
                                    </label>
                                </div>
                            </div>
                        </div><!--form-group-->
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12">
                                <button class="btn btn-primary btn-sm" type="submit">@lang('frontend_auth.register.register_button')</button>
                            </div>
                        </div><!--form-group-->
                    </x-forms.post>
                </div><!--col-md-8-->
